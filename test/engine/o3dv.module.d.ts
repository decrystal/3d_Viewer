...
export class EventNotifier {
    ...
    HasEventListener(eventId: any): any;
...
export class Importer3dm extends ImporterBase {
    rhino: any;
    instanceIdToObject: any;
    instanceIdToDefinition: any;
...
export class ImporterThreeBase extends ImporterBase {
    ...
    loader: any;
    materialIdToIndex: any;
    objectUrlToFileName: any;
...
export function LoadExternalLibrary(libName: any): any;
...
export function Utf8StringToArrayBuffer(str: any): ArrayBuffer;
